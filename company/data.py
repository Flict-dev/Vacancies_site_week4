...
jobs = [
    ...
    {"id": "3", "title": "Middle SWIFT-разработчик", "specialty": "backend", "company": "1",
     "salary_min": "120000", "salary_max": "150000", "published": "2020-03-11",
    ...
    {"id": "4", "title": "Мидл программист на Python", "specialty": "backend", "company": "7", "salary_min": "80000",
     "salary_max": "90000", "published": "2020-03-11", "skills": "Python, Docker, MySQL",
    ...
    {"id": "5", "title": "Грамотный питон разработчик", "specialty": "backend", "company": "8", "salary_min": "120000",
     "salary_max": "150000", "published": "2020-03-11", "skills": "Python, Django, PostgreSQL, Git",
...
for i in jobs:
    Vacancy.objects.create(
        title=i['title'],
        speciality=Speciality.objects.get(code=i['specialty']),
